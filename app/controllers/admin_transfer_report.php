...
class AdminTransferReportController
{
    public function handleRequestAdminTransfer()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_admin_transfer'])) {
...
$controller = new AdminTransferReportController();
$controller->handleRequestAdminTransfer();
