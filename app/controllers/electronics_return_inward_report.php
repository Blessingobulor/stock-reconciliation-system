...
class ElectronicsReturnInwardReportController
{
    public function handleRequestElectronicsReturnInward()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_electronics_return_inward'])) {
...
$controller = new  ElectronicsReturnInwardReportController();
$controller->handleRequestElectronicsReturnInward();
