...
class TransferCctvReportController
{
    public function handleRequestTransferCctv()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_transfer_cctv'])) {
...
$controller = new TransferCctvReportController();
$controller->handleRequestTransferCctv();
