...
class TransferToBranchReportController
{
    public function handleRequestTransferBranch()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_transfer_branch'])) {
...
$controller = new TransferToBranchReportController();
$controller->handleRequestTransferBranch();
