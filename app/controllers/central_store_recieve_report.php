...
class CentralStoreRecieveReportController
{
    public function handleRequestCentralStoreRecieve()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_central_store_recieve'])) {
...
$controller = new CentralStoreRecieveReportController();
$controller->handleRequestCentralStoreRecieve();
