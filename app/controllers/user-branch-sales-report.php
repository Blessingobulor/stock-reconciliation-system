...
if(Auth::access('cashier')) 
{
	if(Auth::access('supervisor')){
		require_once views_path('user-branch-sales-report/user-branch-sales-report');

	}else{

		require_once views_path('user-branch-sales-report/branch_sales_report');
	}
