...
class BranchSalesRecieptReportController
{
    ...
    {
        require_once views_path('user-branch-sales-invoice-reciept-report/branch_sales_invoice_reciept_report');
...
$controller = new BranchSalesRecieptReportController();
