...
class CctvStoreStockReportController
{
    public function handleRequestCctvStoreStock()
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            if (isset($_POST['generate_report_cctv_store_stock'])) {
...
$controller = new CctvStoreStockReportController();
$controller->handleRequestCctvStoreStock();
