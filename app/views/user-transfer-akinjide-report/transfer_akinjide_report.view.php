...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM transfer_akinjide WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>AKINJIDE STOCK TRANSFER REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=transfer-akinjide-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_transfer_akinjide" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-transfer-akinjide-report">
        <input type="hidden" name="tab" value="transfer_akinjide_report">
         ...
         buttons: [
            {
               ...
               title: 'Akinjide Transfer Report'
            },
            {
               extend: 'print',
               exportOptions: {
