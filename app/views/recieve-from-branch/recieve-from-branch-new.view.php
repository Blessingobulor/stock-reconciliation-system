...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
    <a href="index.php?pg=recieve_from_branch_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i>Recieve From Branch</h3>
        </center>
        ...
        <div class="col mb-3">
    <label for="reasonsforrecievingofstockControlInput1" class="form-label">Reasons For Recieving Of Stock </label>
    <textarea name="reasons_for_recieving_of_stock" class="form-control" id="reasonsforrecievingofstockControlInput1" rows="4" placeholder="Enter your reasons for the recieving of stock "></textarea>
</div>
