...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM central_store_transfer WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>CENTRAL STORE STOCK TRANSFER REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=central-store-transfer-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_central_store_transfer" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-central-store-transfer-report">
        <input type="hidden" name="tab" value="central_store_transfer_report">
         ...
         buttons: [
            {
               ...
               title: 'Central Store Transfer Report'
            },
            {
               extend: 'print',
               exportOptions: {
