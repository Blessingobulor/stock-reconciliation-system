...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM branch_sales WHERE id = $id");
...
<div>
	...
	<form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
		...
		<br><br>
            ...
            class="btn btn-primary btn-sm col" name="generate_report_branch" type="submit"> Generate</button>

            </a>

		<input type="hidden" name="pg" value="user-branch-sales-report">
      <input type="hidden" name="tab" value="branch_sales_report">
         ...
         buttons: [
            {
               ...
               title: 'Customer Sales Invoice Report'
            },
            {
               extend: 'print',
               exportOptions: {
