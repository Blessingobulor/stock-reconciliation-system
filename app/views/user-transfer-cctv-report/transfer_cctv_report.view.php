...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM transfer_cctv WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>CCTV STOCK TRANSFER REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=transfer-cctv-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_transfer_cctv" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-transfer-cctv-report">
        <input type="hidden" name="tab" value="transfer_cctv_report">
