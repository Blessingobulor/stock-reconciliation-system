...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
    <a href="index.php?pg=recieve_cctv_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i> CCTV Stock Recieve</h3>
        </center>

        <div class="mb-3 mt-3">
            <label for="recievestockidControlInput1" class="form-label">Recieve Stock Id</label>
                <input type="text" class="form-control" name="recieve_stock_id" id="id" value ="TS<?= rand(1000, 9999) ?>" readonly>
        ...
        <div class="mb-3 mt-3">
            <label for="dateControlInput1" class="form-label">Recieved Date</label>
        ...
        <select name="category_0" class="form-control <?=!empty($errors['category']) ? 'border-danger' : ''?>" required>
            ...
            <option value="Power Box">Power Box</option>
...
<script>
    ...
    '8 CHANNEL DVR 5MP', '16 WAYS POWER BOX', '8 WAYS POWER BOX', 'POWER ADPTOR', '10M HDTV CABLE(HDMI)', '5M HDTV CABLE(HDMI)', 'OLAX 4G WIFI ROUTER', '3K SMART HYBRID DOME CAMERA', 
