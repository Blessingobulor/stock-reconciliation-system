...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM admin_transfer WHERE id = $id");



    // update the stock quantity in the stock table when deleted
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>BRANCH ADMIN TRANSFER REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=admin-transfer-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_admin_transfer" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-admin-transfer-report">
        <input type="hidden" name="tab" value="admin_transfer_report">
        ...
        <tbody>
            ...
            <?php  foreach($report as $report): ?>
                <tr>
                    ...
                    <td><?=$report['reasons_for_transfer']?></td>
