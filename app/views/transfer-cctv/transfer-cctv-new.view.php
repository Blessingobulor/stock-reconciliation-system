...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
    <a href="index.php?pg=transfer_cctv_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i> CCTV Stock Transfer</h3>
        </center>
        ...
        <div class="mb-3 mt-3">
            <label for="dateControlInput1" class="form-label">Transfer Date</label>
