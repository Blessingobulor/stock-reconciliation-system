...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
     <a href="index.php?pg=return_stock_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i>Return Stock</h3>
        </center>
        ...
        <div class="mb-3 mt-3">
            ...
            <select name="branch_name" class="form-control <?=!empty($errors['branch_name']) ? 'border-danger' : ''?>" id="branchnameControlInput1" placeholder="branch name">
                ...
                <option>Bodija Branch</option>
                <option>Greener World Ilorin Branch</option>
                <option>Tipper Garage Branch</option>
                <option>Gw Akure Branch</option>
        ...
        <div class="mb-3 mt-3">
            ...
            <select name="destination" class="form-control <?=!empty($errors['destination']) ? 'border-danger' : ''?>" id="destinationControlInput1" required>
                ...
                <option value="Greener World ilorin Branch">Greener World ilorin Branch</option>
                <option value="Tipper Garage Branch">Tipper Garage Branch</option>
                <option value="Gw Akure Branch">Gw Akure Branch</option>
    ...
    <textarea name="reasons_for_return_of_stock" class="form-control" id="reasonsforreturnofstockControlInput1" rows="4" placeholder="Enter your reasons for the return of stock "></textarea>
</div>
