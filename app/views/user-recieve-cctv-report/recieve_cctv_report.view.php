...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM recieve_cctv WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>CCTV STOCK RECIEVED REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=recieve-cctv-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_recieve_cctv" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-recieve-cctv-report">
        <input type="hidden" name="tab" value="recieve_cctv_report">
