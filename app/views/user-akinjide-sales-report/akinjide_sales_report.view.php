...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM akinjide_sales WHERE id = $id");
...
<div>
	...
	<form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
		...
		<br><br>
				...
				<a href="index.php?pg=akinjide-sales-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_akinjide" type="submit"> Generate</button>

            </a>

		<input type="hidden" name="pg" value="user-akinjide-sales-report">
      <input type="hidden" name="tab" value="akinjide_sales_report">
