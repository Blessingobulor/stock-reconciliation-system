...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM recieve_akinjide WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>AKINJIDE STOCK RECIEVED REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=recieve-akinjide-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_recieve_akinjide" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-recieve-akinjide-report">
        <input type="hidden" name="tab" value="recieve_akinjide_report">
