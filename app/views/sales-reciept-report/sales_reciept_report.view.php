...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
        ...
        <br><br>
            ...
            class="btn btn-primary btn-sm col" name="generate_sales_reciept" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-sales-reciept-report">
      <input type="hidden" name="tab" value="sales_reciept_report">
