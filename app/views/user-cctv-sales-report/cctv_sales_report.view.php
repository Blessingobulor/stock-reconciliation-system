...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM cctv_sales WHERE id = $id");
...
<div>
	...
	<form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
		...
		<br><br>
				...
				<a href="index.php?pg=cctv-sales-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_cctv" type="submit"> Generate</button>

            </a>

		<input type="hidden" name="pg" value="user-cctv-sales-report">
      <input type="hidden" name="tab" value="cctv_sales_report">
