...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM central_store_transfer_to_branch WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>CENTRAL STORE TRANSFER TO BRANCH REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=central-store-transfer-to-branch-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_central_store_transfer_branch" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-central-store-transfer-to-branch-report">
        <input type="hidden" name="tab" value="central_store_transfer_to_branch_report">
         ...
         buttons: [
            {
               ...
               title: 'Central Store Transfer To Branch Report'
            },
            {
               extend: 'print',
               exportOptions: {
