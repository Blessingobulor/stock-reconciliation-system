...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
    <a href="index.php?pg=admin_transfer_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i>Branches Admin Transfer</h3>
        </center>
        ...
        <div class="mb-3 mt-3">
         ...
         <div class="mb-3 mt-3">
            <label for="reasonsfortransferControlInput1" class="form-label">Reasons For Transfer</label>
            <select name="reasons_for_transfer" class="form-control <?=!empty($errors['reasons_for_transfer']) ? 'border-danger' : ''?>" id="reasonsfortransferControlInput1" placeholder="Choose your reasons for transfer of stock">
                <option selected>Choose...</option>
                 <option>Branch usage</option>
                 <option>Personal Usage</option>
                  <option>Not Specified</option>
            </select>
            <?php if(!empty($errors['reasons_for_transfer'])):?>
                <small class="text-danger"><?=$errors['reasons_for_transfer']?></small>
            <?php endif;?>
        </div>
