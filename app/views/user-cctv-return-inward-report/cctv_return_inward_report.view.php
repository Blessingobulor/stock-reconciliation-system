...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM cctv_return_inward WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>CCTV RETURN INWARD REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=cctv-return-inward-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_cctv_return_inward" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-cctv-return-inward-report">
        <input type="hidden" name="tab" value="cctv_return_inward_report">
         ...
         buttons: [
            {
               ...
               title: 'CCTV Customer Return Inward Report'
            },
            {
               extend: 'print',
               exportOptions: {
