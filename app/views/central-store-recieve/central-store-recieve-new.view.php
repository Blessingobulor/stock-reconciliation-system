...
<div class="container-fluid border col-lg-7 col-md-6 mt-4 p-3 shadow-lg rounded">
    <a href="index.php?pg=central_store_recieve_report">
    ...
    <form id="stock-form" name="myform" method="post">
        <center>
            <br>
            <h3><i class="fa fa-dolly"><br></i>Central Store Stock Recieved</h3>
        </center>

        <div class="mb-3 mt-3">
            <label for="recievestockidControlInput1" class="form-label">Recieved Stock Id</label>
                <input type="text" class="form-control" name="recieve_stock_id" id="id" value ="RS<?= rand(1000, 9999) ?>" readonly>

            <?php if(!empty($errors['recieve_stock_id'])):?> 
        ...
        <div class="mb-3 mt-3">
            ...
            <select name="source" class="form-control <?=!empty($errors['source']) ? 'border-danger' : ''?>" id="sourceControlInput1" required>
                ...
                <option value="Customer Care Unit">Customer Care Unit</option>
                <option value="Repair Center">Repair Center</option>
                <option value="MD's Office">MD's Office</option>
                <option value="Tokumbo Store">Tokumbo Store</option>
                <option value="Novel Admin">Novel Admin</option>
        ...
        <div class="mb-3 mt-3">
           ...
           <div class="mb-3 mt-3">
            <label for="nameofrecieverControlInput1" class="form-label">Name Of Reciever</label>
            <input type="name" name="name_of_reciever" class="form-control <?=!empty($errors['name_of_reciever']) ? 'border-danger' : ''?>" id="nameofrecieverControlInput1">
            <?php if(!empty($errors['name_of_reciever'])):?>
                <small class="text-danger"><?=$errors['name_of_reciever']?></small>
            <?php endif;?>
        </div>
         ...
         <div class="mb-3 mt-3">
            ...
            <select name="recieved_by" class="form-control <?= !empty($errors['recieved_by']) ? 'border-danger' : '' ?>" id="recievedbyControlInput1" placeholder="Recieved By">
                <option selected>Choose...</option>
