...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['delete_stock'])) {
   ...
   $db->query("DELETE FROM electrical_store_transfer_to_branch WHERE id = $id");
...
<div>
    ...
    <form style="margin: 40px;"class="row float-end <?= !Auth::access('cashier') ?> ">
            <h2>ELECTRICAL STORE TRANSFER TO BRANCH REPORT</h2>
        ...
        <br><br>
                ...
                <a href="index.php?pg=electrical-store-transfer-to-branch-new">
            ...
            class="btn btn-primary btn-sm col" name="generate_report_electrical_store_transfer_branch" type="submit"> Generate</button>

            </a>

        <input type="hidden" name="pg" value="user-electrical-store-transfer-to-branch-report">
        <input type="hidden" name="tab" value="electrical_store_transfer_to_branch_report">
